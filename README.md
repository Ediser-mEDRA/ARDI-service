...
## DRS submission with correct parameters
 ...
 ================================ 
  ...
  The response body provided through the REST API in the form of a JSON includes:
   ...
   | Subfield "drs" in field statement|The whole original DRS submitted in XML format. Noticed that, if the original DRS in XML format doesn't contains the ARDI identifier after the submission, in case of **SUCCESS**, the field will contain the ARDI identifier generated by the web application|
   |Accounting| The results for operations and services as described in the next table|
